        ...
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl shadow-orange-600/40 ring ring-2 ring-orange-500 lg:max-w-xl">
                ...
                <form className="mt-6">
                    ...
                    <div className="mt-6">
                        <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-orange-500 rounded-md hover:bg-orange-300 focus:outline-none focus:bg-purple-600">
                            Login
                        </button>
                    </div>
                </form>
